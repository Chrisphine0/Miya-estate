...
export default function TheBeverlyThreePage() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-8">
              ...
              <div className="flex flex-col items-end">
                <div className="bg-[#f9f5ed] rounded-full px-4 py-2 flex items-center mb-4">
                  ...
                  <span className="text-sm font-medium">Now Leasing</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full h-[400px] relative">
            <Image src="/Photo 06.png" alt="The Beverly apartments exterior" fill className="object-cover" />
          </div>
        </section>
              ...
              <div className="grid grid-cols-3 gap-4 md:w-1/2">
                {[1, 2, 3, 4, 5, 6].map((item) => (
                  <div key={item} className="relative aspect-square overflow-hidden rounded-md">
                    <Image src="/Photo 09.png" alt={`Property image ${item}`} fill className="object-cover" />
                    {item === 1 && (
              ...
              {[1, 2, 3, 4].map((unit) => (
                <div key={unit} className="flex flex-col">
                  <div className="relative h-[200px] overflow-hidden rounded-lg mb-4">
                    <Image src="/Photo 15.png" alt={`Unit ${unit}`} fill className="object-cover" />
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2">
                <p className="text-xl leading-relaxed mb-6">
                  "I've lived in several apartment communities, but theBEVERLY stands out for its attention to detail
                  and quality. The management team is responsive and the maintenance staff is always prompt and
                  professional."
                </p>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative h-[300px] overflow-hidden rounded-lg">
                <Image src="/Photo 09.png" alt="Community amenities" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
